...
router.post('/submit-summary', isStudentLoggedIn, upload.single('summaryFile'), studentdetails.submitSummary);
router.post('/edit-summary/:id', isStudentLoggedIn, upload.single('summaryFile'), studentdetails.editSummary);
